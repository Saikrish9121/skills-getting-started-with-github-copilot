...
activities = {
    ...
    "Basketball Team": {
        "description": "Team-based basketball practice and competition",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Stroke development and lap swimming for all levels",
    ...
    "Music Ensemble": {
        "description": "Rehearse and perform instrumental and vocal music",
